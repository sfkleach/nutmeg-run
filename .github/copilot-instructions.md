...
This is a GNU C++ project that implements a threaded interpreter for the
Nutmeg programming language. The interpreter is based on a stack machine
partially implemented in https://github.com/sfkleach/poppy
